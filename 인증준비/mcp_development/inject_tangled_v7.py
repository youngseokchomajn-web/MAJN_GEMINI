...
def main():
    ...
    print("Configuring PCB and Board Outline...")
    # configure_pcb will draw the outline and activate the document
    client.configure_pcb(100, 100, 2)
    
    print("Waiting 10 seconds for EasyEDA canvas state to fully initialize (attrsMap)...")
    time.sleep(10.0)

    print("Applying DRC 0.1mm rule...")
    JS_DRC = """
    try {
    ...
    print("Caching parts...")
    client.cache_components(["C165948", "C84681", "C9421"])

    print("Placing components...")
    # Use mm coordinates around the center
    client.place_component("TYPE_C", "USB", "C165948", 50, 50, 0)
    client.place_component("SOP16", "CH340C", "C84681", 50, 60, 90) # 10mm apart
    client.place_component("C1", "10uF", "C9421", 45, 55, 0)
    client.place_component("C2", "10uF", "C9421", 55, 55, 0)
